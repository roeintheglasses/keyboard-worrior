		...
		<div>
			<div class="xyz-in" xyz="fade up big">
				...
				<p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">
					One stop of all your mechnical keyboard building, breaking & buying needs.
				</p>
			...
			<div
				class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]"
			>
				<svg
